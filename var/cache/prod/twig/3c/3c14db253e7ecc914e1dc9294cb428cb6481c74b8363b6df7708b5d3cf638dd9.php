...
class __TwigTemplate_6971a0b05bd7ea4eae3a8327281523cc83f72b51d3440f7a71142399ea4236a3 extends Twig_Template
{
    ...
    {
        // line 12
        return $this->loadTemplate($this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "getTemplate", array(0 => "base_list_field"), "method"), "@SonataAdmin/CRUD/Association/list_many_to_one.html.twig", 12);
    }
...
(isset($context["field_description"]) ? $context["field_description"] : null), "associationadmin", array()), "hasAccess", array(0 => (isset($context["route_name"]) ? $context["route_name"] : null), 1 => (isset($context["value"]) ? $context["value"] : null)), "method"))) {
    ...
    {
        return new Twig_Source("", "@SonataAdmin/CRUD/Association/list_many_to_one.html.twig", "C:\\wamp64\\www\\Jobeet\\vendor\\sonata-project\\admin-bundle\\Resources\\views\\CRUD\\Association\\list_many_to_one.html.twig");
    }
}
